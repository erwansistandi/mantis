...
--
-- Host: 127.0.0.1    Database: mantis
-- ------------------------------------------------------
...
INSERT INTO `mantis_config_table` VALUES ('database_version',0,0,90,1,'211'),('plugin_Gravatar_schema',0,0,90,1,'-1'),('plugin_MantisGraph_schema',0,0,90,1,'-1'),('plugin_TimeTracking_schema',0,0,90,1,'0'),('plugin_XmlImportExport_schema',0,0,90,1,'-1');
...
--
-- Table structure for table `mantis_plugin_TimeTracking_data_table`
--

DROP TABLE IF EXISTS `mantis_plugin_TimeTracking_data_table`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Dumping data for table `mantis_plugin_TimeTracking_data_table`
--

LOCK TABLES `mantis_plugin_TimeTracking_data_table` WRITE;
/*!40000 ALTER TABLE `mantis_plugin_TimeTracking_data_table` DISABLE KEYS */;
/*!40000 ALTER TABLE `mantis_plugin_TimeTracking_data_table` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `mantis_plugin_table` VALUES ('Gravatar',1,0,3),('MantisCoreFormatting',1,0,3),('MantisGraph',1,0,3),('TimeTracking',1,0,3),('XmlImportExport',1,0,3);
...
INSERT INTO `mantis_tokens_table` VALUES (2,1,5,'{\"filter\":false,\"sidebar\":false}',1752227857,1784002182),(6,1,4,'1',1752466612,1752466912);
...
INSERT INTO `mantis_user_table` VALUES (1,'administrator','admin mantis','erwan.sistandi@bvk.co.id','eb5c7c6e643bac6057bcff0386681db4',1,0,90,11,0,0,'73lntslTSQ5VqukC4siantQ5A4L_xGKQMmooW3x4v9C_x_YFItqyp6Brys6IL0T1',1752466612,1752227733);
...
-- Dump completed on 2025-07-14 12:04:45
